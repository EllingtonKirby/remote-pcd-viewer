...
document.addEventListener("DOMContentLoaded", function () {
    ...
    async function loadPointCloud(url, color) {
    ...
    loadPointCloud(`${baseURL}/0`, { r: 1, g: 1, b: 1 });
    // loadPointCloud(`${baseURL}generated_0.txt`, { r: 1, g: 0, b: 0 });
    // loadPointCloud(`${baseURL}generated_1.txt`, { r: 0, g: 0, b: 1 });
